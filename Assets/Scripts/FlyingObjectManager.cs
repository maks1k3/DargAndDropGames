...
public class FlyingObjectManager : MonoBehaviour
{
    ...
    {
        FlyingObjectsControllerScript[] flyingObjects = Object.FindObjectsByType<FlyingObjectsControllerScript>(FindObjectsInactive.Exclude, FindObjectsSortMode.None);
